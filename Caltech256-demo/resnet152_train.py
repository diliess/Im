...
#train
log_folder = 'logresnet152.txt' # 指定 log 文件夹路径
...
for epoch in range(num_epochs):
    ...
    # 测试模型准确率
    accuracy = test_accuracy(resnet152, test_dataloader, device)
    print(f"Epoch {epoch+1} accuracy on train set: {accuracy:.2f}%")

    scheduler.step()

print("Training finished.")
save_path = 'model/resnet152.pth'
torch.save(resnet152.state_dict(), save_path)