...
# 从.pth文件中加载预训练参数
EfficientNet.load_state_dict(torch.load(r'model/hub/checkpoints/efficientnet_b4_rwightman-7eb33cd5.pth',map_location='cpu'))
#改写网络结构
EfficientNet.classifier._modules['1'] = nn.Linear(1792,257)
...
#train
log_folder = 'log_efficientNetb4.txt' # 指定 log 文件夹路径
...
save_path = 'model/EfficientNetb4_out1.pth'
